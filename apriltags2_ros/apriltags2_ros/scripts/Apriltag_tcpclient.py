...
def callback(vecTagDetections):
    ...
    data = "###"
    data = data + str(vecTagDetections.detections[0].pose.pose.pose.postion.x) + ","
    data = data + str(vecTagDetections.detections[0].pose.pose.pose.postion.y) + ","
    data = data + str(vecTagDetections.detections[0].pose.pose.pose.postion.z) + ","
